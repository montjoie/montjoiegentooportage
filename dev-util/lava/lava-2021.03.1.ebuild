...
if [[ "${PV}" != "9999" ]]; then
	SRC_URI="https://git.lavasoftware.org/lava/lava/-/archive/2021.03.post1/2021.03.post1.tar.gz"
...
S=${WORKDIR}/lava-2021.03.post1-6b4fef882f3315365077a5f3a8d8c0b0d22cfd60
